...
const Matrix = ({ title, amount, growth, growthType, icon,tag,onClick}) => {
  return (
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-between">
          ...
          <p className="sm:text-[13px] xl:text-[16px]  2xl:text-[16px] ml-[5px] text-[#606060] leading-[21.82px] font-normal no-whitespace">
           {tag?tag:"Up from yersterday"} 
          </p>
        </div>
        <div>
          <button className="sm:text-[9px] xl:text-[12px]  2xl:text-[13px]  bg-[#F3F3F3] rounded-[5px] px-[12px] py-[4px]" onClick={onClick}>
            View All
          </button>
        </div>
      </div>

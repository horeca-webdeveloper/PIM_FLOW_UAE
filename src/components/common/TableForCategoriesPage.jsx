...
const TableForCategoriesPage = ({
  ...
  const cellClass = "px-3 py-2  text-sm text-gray-500 border capitalize";
  const headerClass =
    ...
    <div className="p-1 mt-0 ml-2 mr-2 w-[100px] bg-[#FAFBFD] border-[#BCBCBC] flex items-center justify-center space-x-3 border rounded-md">
     ...
     {console.log("rowdata",rowData)}
      <img
        ...
        onClick={() => getDatafn(rowData.category_id,rowData?.category_id,rowData?.title)}
      />
      {!disableDelete && (
        <>
...
export default TableForCategoriesPage;

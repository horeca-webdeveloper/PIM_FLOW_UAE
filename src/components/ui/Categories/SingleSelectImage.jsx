...
const SingleSelectImage = ({ title, spanTags,  fileName, altText, fileLength, control, register, namePrefix, selectedBanner, selectedAltText, selectedFileName, setValue, fileNameTitle, accept }) => {

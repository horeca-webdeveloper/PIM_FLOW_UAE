    ...
    <>
      {isLoading ? (
        ...
        <div className="min-h-screen">
          <BrandHeader general={generalData} setGeneralData={setGeneralData} />
          ...
          <CollapseComponent title="Categories Section">
            <CategoriesSectionComponent
              ...
              fileName={true}
              altText={true}
              spanTags="Categories Thumbnail & Name (Webp format allowed (max 10MB, must be 1920x450px)"
              mediaData={mediaData}
              setMediaData={setMediaData}
            />
          </CollapseComponent>
                          ...
                          {options &&
                            options.map((item) => (
                              <div
                                ...
                                className={`text-[16px] leading-[17.64px] font-light text-[${
                                  item.textColor
                                }] ${
                                  ...
                                  item.fontWeight
                                } rounded-[5px] py-[8px] flex items-center gap-2`}
                              >
                                {item.label}
                              </div>
                            ))}

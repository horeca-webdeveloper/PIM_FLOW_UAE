...
const BrandCustomizationFirst = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (uid) {
      ...
      Apis.updateFirstBrandPage(formData, uid, setLoader, setResponse);
    } else {
      Apis.createFirstBrandPage(formData, setLoader, setResponse);
    }
  };
  ...
  useEffect(() => {
    if (uid) {
      Apis.fetchBrandFirstPageById(uid, setLoader, setBrandPageDetails);
      ...
      {loader ? (
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="min-h-screen">
            ...
            <CollapseComponent title="Categories Section">
              <div className="bg-white mt-[-20px]">
                <div className="">
                  <>

                    <CategoryMedia
                      title="Categories Thumbnail & Names"
                      fileLength={4}
                      fileName={true}
                      altText={true}
                      control={control}
                      ...
                      spanTags="Categories Thumbnail & Names (Webp format allowed (max 10MB, must be 1920x450px)"
                    />
                  </>
                </div>
              </div>
...
export default React.memo(BrandCustomizationFirst);

...
const BrandListThird = () => {
  ...
  const deleteBrandById = (id) => {
    ...
    if (confirmDelete) {
      Apis.deleteBrandThird(id, setLoader, setResponse);
    }
  };

  useEffect(() => {
    Apis.fetchBrands(setBrandLoader, setBrands);
    Apis.fetchBrandThirdPage(setBrandLoader, setBrandData);
  }, []);
      ...
      {fetchBrandloader ? (
        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <CreateBrandsPopup
              title="Create Second Brand Template"
              loader={loader}
              control={control}
...
export default React.memo(BrandListThird);

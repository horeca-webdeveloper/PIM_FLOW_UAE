    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <HeaderComponent label="Export Features & Benefits" span="" buttons={buttons} />

                {/* Collapsible Section */}
                <CollapseComponent title="Export Features & Benefits"
                ...
                >
                    <div className="space-y-4">
                        ...
                        <InputComponent label="From Range" bgTransparent={true} type="number" min="1" placeholder="Enter from range" name="from"  {...register("from", { required: "From range is required" })} />
                        {errors.from && <p className="text-red-500">{errors.from.message}</p>}
                        <InputComponent label="To Range" type="number" bgTransparent={true} min="1"  placeholder="Enter To range" name="to"   {...register("to", { required: "To range is required" })} />

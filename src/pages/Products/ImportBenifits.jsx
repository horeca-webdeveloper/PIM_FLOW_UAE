    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <HeaderComponent label="Import Features & Benefits" span="" buttons={buttons} />

                {/* Collapsible Section */}
                <CollapseComponent title="Import Features & Benefits">
...
export default React.memo(ImportBenifits);

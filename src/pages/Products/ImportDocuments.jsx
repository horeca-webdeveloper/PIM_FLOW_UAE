...
const ImportDocuments = () => {
    ...
    const url = "/product/upload-documents";
    const {
        register,
        handleSubmit,
        watch,
    ...
    const onSubmit = async (data) => {
        ...
        await Apis.ImportDocuments(formData, setLoader, setResponse, url);
        reset();
    };
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <HeaderComponent label="Import Documents" span="" buttons={buttons} />

                {/* Collapsible Section */}
                <CollapseComponent title="Import">
                    <div className="space-y-4">
                        <label>ZIP file containing product documents organized in folders by SKU</label>
                        <InputComponent
                            label="Upload File"
                            type="file"
                             accept="*/*"
...
export default React.memo(ImportDocuments);

...
const VendorImport = () => {
  ...
  const [module, setModule] = useState("Vendor");
  ...
  const onSubmit = async (data) => {
    ...
    await Apis.importVendorData(formData, setLoader, setResponse, url);
    reset();
  };
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <HeaderComponent label="Import Vendor" span="" buttons={buttons} />
...
export default React.memo(VendorImport);
